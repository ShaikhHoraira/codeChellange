...
export class SaveMarketingCostData {
  ...
  public async saveMarketingData(): Promise<any> {
    try {
      const bodyParams = JSON.parse(this.payload.body);
      const params: PutItemCommandInput = {
        TableName: tableName,
        Item: {
          MarketingInvoiceId: { S: bodyParams.marketingInvoiceId },  // Specifying string type for UserId

...
import OperationCostSchema from '../../src/schema/operationCostSchema'

const validRequest = {
    employeeId: "1321321321+564",
    customerName: "Sam",
    appartmentNo : "503",
...
describe('Authenticated Register endpoint handler', () => {
  ...
  beforeEach(() => {
    v = new Validator();
    v.addSchema(OperationCostSchema as Schema);
  });

  describe('Schema', () => {
    it('Should pass the schema', () => {
      const result = v.validate(validRequest, OperationCostSchema as Schema);
  ...
  describe('Address', () => {
    it('Should support minimum length of 1', () => {
      ...
      const result = v.validate(customRequest, OperationCostSchema as Schema);

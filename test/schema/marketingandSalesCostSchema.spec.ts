...
import MarketingandSalesCostSchema from '../../src/schema/marketingandSalesCostSchema'

const validRequest = {
    marketingInvoiceId: "1321321321+564",
    customerName: "Sam",
    appartmentNo : "503",
...
describe('Authenticated Register endpoint handler', () => {
  ...
  beforeEach(() => {
    v = new Validator();
    v.addSchema(MarketingandSalesCostSchema as Schema);
  });

  describe('Schema', () => {
    it('Should pass the schema', () => {
      const result = v.validate(validRequest, MarketingandSalesCostSchema as Schema);
  ...
  describe('Address', () => {
    it('Should support minimum length of 1', () => {
      ...
      const result = v.validate(customRequest, MarketingandSalesCostSchema as Schema);

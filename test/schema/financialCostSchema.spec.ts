...
import FinancialCostSchema from '../../src/schema/financialCostSchema'

const validRequest = {
    insuranceId: "1321321321+564",
    customerName: "Sam",
    appartmentNo : "503",
...
describe('Authenticated Register endpoint handler', () => {
  ...
  beforeEach(() => {
    v = new Validator();
    v.addSchema(FinancialCostSchema as Schema);
  });

  describe('Schema', () => {
    it('Should pass the schema', () => {
      const result = v.validate(validRequest, FinancialCostSchema as Schema);
  ...
  describe('Address', () => {
    it('Should support minimum length of 1', () => {
      ...
      const result = v.validate(customRequest, FinancialCostSchema as Schema);

...
import ProductionCostcostSchema from '../../src/schema/productionCostSchema'

const validRequest = {
    productionCostId: "1321321321+564",
    customerName: "Sam",
    appartmentNo : "503",
...
describe('Authenticated Register endpoint handler', () => {
  ...
  beforeEach(() => {
    v = new Validator();
    v.addSchema(ProductionCostcostSchema as Schema);
  });

  describe('Schema', () => {
    it('Should pass the schema', () => {
      const result = v.validate(validRequest, ProductionCostcostSchema as Schema);
  ...
  describe('Address', () => {
    it('Should support minimum length of 1', () => {
      ...
      const result = v.validate(customRequest, ProductionCostcostSchema as Schema);

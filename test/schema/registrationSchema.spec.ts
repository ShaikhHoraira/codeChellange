...
import RegistrationSchema from '../../src/schema/registrationSchema'

const validRequest = {
    userId: "1321321321+564",
    customerName: "Sam",
    appartmentNo : "503",
...
describe('Authenticated Register endpoint handler', () => {
  ...
  beforeEach(() => {
    v = new Validator();
    v.addSchema(RegistrationSchema as Schema);
  });

  describe('Schema', () => {
    it('Should pass the schema', () => {
      const result = v.validate(validRequest, RegistrationSchema as Schema);

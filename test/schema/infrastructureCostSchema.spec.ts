...
import InfrastructureCostSchema from '../../src/schema/infrastructureCostSchema'

const validRequest = {
    rentId: "1321321321+564",
    customerName: "Sam",
    appartmentNo : "503",
...
describe('Authenticated Register endpoint handler', () => {
  ...
  beforeEach(() => {
    v = new Validator();
    v.addSchema(InfrastructureCostSchema as Schema);
  });

  describe('Schema', () => {
    it('Should pass the schema', () => {
      const result = v.validate(validRequest, InfrastructureCostSchema as Schema);
  ...
  describe('Address', () => {
    it('Should support minimum length of 1', () => {
      ...
      const result = v.validate(customRequest, InfrastructureCostSchema as Schema);
